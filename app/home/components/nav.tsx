...
export const Nav = () => {
  ...
  const { name, loggedin, email, setName, setLoggedin, setEmail } = useDataContext();
 //calculator open
 ...
 const handleCalClick=()=>setCal(!cal) 
  ...
  return (
    ...
    <div className='flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-[#e5e4e3] min-h-[70px] relative'>
          ...
          <div className="w-[28px] h-[28px] absolute right-4 top-3" >
              ...
              className="bg-purple-700 text-white w-11 rounded-md">
                   <CalculatorIcon />
  ...
  <LoanCalculator cal={cal} setCal={setCal} handleCalClick={handleCalClick} />
