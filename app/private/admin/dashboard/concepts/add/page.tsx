...
export default function AddDataForm() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4 border rounded shadow-lg bg-white">
      <h1 className="text-xl font-bold mb-4">הוסף מושג חדש</h1>
